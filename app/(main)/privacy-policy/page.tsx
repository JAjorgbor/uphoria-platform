...
export default function PrivacyPolicyPage() {
  return (
    <Container className="space-y-4">
      <Card>
        <h1 className="text-3xl font-bold mb-4 text-rose-800">
          Privacy Policy
        </h1>
        <p className="text-sm mb-8">
          Effective Date: <strong className="text-rose-800">11/16/2024</strong>
        </p>

        <section className="mb-6">
          <h2 className="text-xl font-semibold mb-2">Introduction</h2>
          <p>
            Welcome to <strong className="text-rose-800">Uphoria</strong>. We
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside pl-4 space-y-2 mt-2">
            <li>
              <strong className="text-rose-800">Personal Information:</strong>{" "}
              Name, email address, phone number, and other contact details.
            </li>
            <li>
              <strong className="text-rose-800">Usage Data:</strong> Information
              about how you interact with our platform, including pages visited,
